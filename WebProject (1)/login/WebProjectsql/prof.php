      ...
      <ul>
        ...
        <div class="content w-full">
            ...
            <div class="containerss">
                ...
                <?php
// Vérifier si le bouton d'ajout a bien été cliqué
if(isset($_POST['buttonsubb'])){
    // Extraire les informations envoyées dans des variables via la méthode POST
    extract($_POST);
    ...
    if(isset($nom) && isset($prenom)  && isset($profession) && isset($iprofession) && isset($Nationalite) && isset($ville)){
        ...
        // Requête d'ajout
        $req = mysqli_query($con , "INSERT INTO `prof` (`nom`, `prenom`, `profession`, `iprofession`, `Nationalite`, `ville`,`image`) VALUES ('$nom', '$prenom','$profession','$iprofession','$Nationalite','$ville','$image')");
        if($req){
            // Si la requête a été effectuée avec succès, on peut faire une redirection
        ...
        // Afficher un message si tous les champs n'ont pas été remplis
            ...
            <div class="containerr">
                ...
                <div class="cardd">
                    <div class="card__border">
                        ...
                        <img src="images/<?php echo$row['image'];?>" alt="image de la carte" class="card__img">
