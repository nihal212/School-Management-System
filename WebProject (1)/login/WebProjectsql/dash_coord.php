  ...
  <section class="sidebar">
    <nav>
      <ul>
        ...
        <li><a href="../WebProjectsql/Emploi.php">
                      <i class="fas fa-database"></i>
                      <span class="nav-item">Emploi de temps</span>
                    </a></li>
           <li><a href="../WebProjectsql/consulNote/index.php">
                      <i class="fas fa-database"></i>
                      <span class="nav-item">Consulter les notes saisies par un prof</span>
                    </a></li>
        ...
        <li><a href="../WebProjectsql/notes/index.php">
                      <i class="fas fa-database"></i>
                      <span class="nav-item">Saisir les notes</span>
                    </a></li>
