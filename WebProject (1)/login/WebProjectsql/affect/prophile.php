  ...
  <body>
    <?php
       ...
       if(isset($_POST['edit'])){
           ...
           if(isset($_POST['nom'], $_POST['prenom'], $_POST['profession'], $_POST['Nationalite'], $_POST['ville']) && !empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['profession']) && !empty($_POST['Nationalite']) && !empty($_POST['ville'])){
        ...
        <div class="container-fluid mt--7">
          <div class="row">
           ...
           ?>
                ...
                <div class="card-body">
                  <form id="mon-formulaire" form action="" method="POST">
