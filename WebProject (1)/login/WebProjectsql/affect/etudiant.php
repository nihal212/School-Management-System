            ...
            <div class="containerss">
                ...
                <?php
                        ...
                        if(isset($_POST['buttonsubb'])){
                            ...
                            if(isset($nom) && isset($prenom)  && isset($Filliere) && isset($email) && isset($dtn)){
                                 //connexion à la base de donnée
                                 include_once "connexion.php";
                                 //requête d'ajout
                                 $req = mysqli_query($con , "INSERT INTO `etudiant` (`nom`, `prenom`, `Filliere`, `email`, `dtn`) VALUES ('$nom', '$prenom','$Filliere','$email','$dtn')");
                            ...
                            <div class="modal-content">
                                <div class="center">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="txt_field">
                                            <input type="text" name="Filliere" required>
                                            <span></span>
                                            <label>Filliere</label>
                                        </div>
                                        <div class="txt_field">
                                        ...
                                        <div class="txt_field">
                                            <input type="text" name="dtn" required>
                                            <span></span>
                                            <label>Date Naissance</label>
                                        </div>
                                       
                                        <div class="text-center">
                                            <input type="submit" value="Ajouter" name="buttonsubb"
                            ...
                            if(mysqli_num_rows($req) == 0){
                                ...
                                while($row=mysqli_fetch_assoc($req)){
                                    ...
                                    <tr>
                                        ...
                                        <td><button href="modifier.php?id=<?=$row['id']?>" class="editetudiant">Edit</button>
                                            <a href="supprimer.php?id=<?=$row['id']?>" target="_blank" class="removeetudiant" >Remove</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
